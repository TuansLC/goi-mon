...
- [ ] 2. Định nghĩa models & Alembic migration đầu tiên
- [ ] 2.1 Viết SQLAlchemy models cho 10 bảng
...
- [ ] 2.2 Thêm ràng buộc & index ở tầng DB
...
- [ ] 2.3 Sinh & chạy Alembic migration, seed dữ liệu mẫu
...
- [ ] 3.3 Reset PIN & bật/tắt PIN màn bếp
...
- [ ] 4. Quản lý menu & bàn (admin)
- [ ] 4.1 CRUD menu_categories & menu_items
...
- [ ] 4.2 CRUD tables + sinh/sinh lại qr_token + xuất QR
...
- [ ] 7. State machine món ăn (CAS) + huỷ + overdue
- [ ] 7.1 Đổi trạng thái bằng compare-and-swap
...
- [ ] 7.4 Unit test state machine, huỷ, overdue
...
- [ ] 8. Realtime (WebSocket + Redis Pub/Sub)
- [ ] 8.1 Publisher & kênh theo tenant
...
- [ ] 8.2 WS gateway + bridge Redis→client
...
- [ ] 9.2 Test cooldown gọi nhân viên (Property 7)
  - Test 2 request gọi liên tiếp < 60s cho cùng bàn → chỉ 1 call được tạo; > 60s → tạo được call mới; cooldown độc lập giữa các bàn.
  - _Requirements: 7.4_

- [ ] 10. Thanh toán, đóng bàn & in bill
- [ ] 10.1 Checkout (CAS) + auto-cancel món dở + dismiss calls
...
- [ ] 10.2 In bill ESC/POS + fallback PDF
...
- [ ] 10.3 Integration test luồng thanh toán & billing
...
- [ ] 11.1 Job sweep auto-abandon (CAS) + Redis lock
...
- [ ] 11.2 Khôi phục/thanh toán phiên abandoned
...
- [ ] 14. Frontend khách (React + Tailwind)
- [ ] 14.1 Trang menu + giỏ hàng + gửi order
...
- [ ] 14.2 Trạng thái món realtime + gọi nhân viên
